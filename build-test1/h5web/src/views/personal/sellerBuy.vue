	...
	<div class="seller">
		...
		<ul>
			<li>
				...
				<p class="fr">{{orddet.buyUserName}}</p>
				<div class="clear"></div>
			</li>
			<li>
				<p class="fl seller_bt">手机号</p>
				<p class="fr">{{orddet.buyUserMobile}}</p>
				<div class="clear"></div>
			</li>
			<li>
				<p class="fl seller_bt">单位名称</p>
				<p class="fr company">{{orddet.buyMemberName}}</p>
				<div class="clear"></div>
			</li>
			<li>
				<p class="fl seller_bt">纳税人号</p>
				<p class="fr">{{orddet.buyMemberTaxCert}}</p>
				<div class="clear"></div>
			</li>
			<li>
				<p class="fl seller_bt">开户行</p>
				<p class="fr">{{orddet.buyMemberBank}}</p>
				<div class="clear"></div>
			</li>
			<li>
				<p class="fl seller_bt">银行账号</p>
				<p class="fr">{{orddet.buyMemberBankAccount}}</p>
				<div class="clear"></div>
			</li>
		</ul>
	</div>
