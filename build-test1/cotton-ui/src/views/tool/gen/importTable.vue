<template>
  ...
  <el-dialog title="导入表" :visible.sync="visible" width="800px" top="5vh">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      ...
      <el-form-item label="业务库" prop="scheduleName">
        <span slot="label">业务库</span>
        <el-select v-model="queryParams.scheduleName">
...
export default {
  ...
  methods: {
    ...
    /** 导入按钮操作 */
    handleImportTable() {
      importTable({ tables: this.tables.join(","), scheduleName: this.queryParams.scheduleName }).then(res => {
